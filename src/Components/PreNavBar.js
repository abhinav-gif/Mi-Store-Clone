...
const dropDown = <svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 8 40 35" width="15px"><path d="M24 30.8 12 18.8 14.15 16.65 24 26.5 33.85 16.65 36 18.8Z" /></svg>;
    ...
    return (
        <div className="preNav">
            <div>
                ...
                <a href="https://www.mi.com/in/service/authorized_stores/" id="store">RETAIL STORE {dropDown}</a>
            </div>
            <div>
                ...
                <a href="https://store.mi.com/in/site/login" id="cart"> {cartIcon} CART (0)</a>
